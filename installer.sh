#!/bin/bash
##setup command=wget -q "--no-check-certificate" https://raw.githubusercontent.com/speedy005/ChannelSorter/main/installer.sh -O - | /bin/sh
...
if [ ! -d /usr/lib64 ]; then
	...
	PLUGINPATH=/usr/lib64/enigma2/python/Plugins/Extensions/ChannelSorter
fi
...
wget https://github.com/speedy005/ChannelSorter/archive/refs/heads/main.tar.gz || { echo "Download failed"; exit 1; }
tar -xzf main.tar.gz
cp -r 'ChannelSorter-main/usr' /
...
echo ""
echo "#########################################################"
echo "#          speedy00 ChannelSorter INSTALLED SUCCESSFULLY  #"
echo "#                  developed by speedy005                   #"
echo "#                   mod by speedy005                        #"
echo "#                   Big thanks to all                    #"
echo "#                  .::ChannelSorter::.                  #"
